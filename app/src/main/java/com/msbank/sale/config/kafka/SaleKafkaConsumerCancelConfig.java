...
import static com.msbank.sale.core.constants.Constants.Kafka.SALE_CANCEL;
...
@EnableKafka
@Configuration
public class SaleKafkaConsumerCancelConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrap;

    @Bean(name = "${spring.kafka.consumer.bean-receiver-cancel}")
    public ReceiverOptions<String, SaleMessage> kafkaReceiverOptions(@Value(value = "${spring.kafka.consumer.topic}") String topic) {
        ...
        props.put(GROUP_ID_CONFIG, SALE_CANCEL);
    ...
    @Bean(name = "${spring.kafka.consumer.bean-cancel}")
    public ReactiveKafkaConsumerTemplate<String, SaleMessage> reactiveKafkaConsumerTemplate(@Qualifier("${spring.kafka.consumer.bean-receiver-cancel}") ReceiverOptions<String, SaleMessage> kafkaReceiverOptions) {
