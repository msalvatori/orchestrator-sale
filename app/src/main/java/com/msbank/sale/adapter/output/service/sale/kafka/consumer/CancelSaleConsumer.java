...
import static com.msbank.sale.core.constants.Constants.Sale.SALE;
import static com.msbank.sale.core.constants.Constants.Sale.CANCELANDO_A_VENDA;
import static com.msbank.sale.core.constants.Constants.Sale.VENDA_CANCELADA;
                ...
                .doOnNext(saleMessage -> {
                    ...
                    if(SaleEvent.CANCEL_SALE.equals(saleMessage.getSaleEvent())) {
                        ...
                        FindSaleByIdUseCase.execute(saleMessage.getSale().getId())
                                .doOnSuccess(sale -> {
                                    CancelSaleUseCase.execute(saleMessage.getSale());
                                }).block();
